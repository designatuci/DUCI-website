			...
			<Section className="center page short">
				...
				>
					...
					<Text className="color gray">
						Those who applied should expect an email during Week 8
						regarding mentorship fams!
					</Text>

					<br />
					<Text size="L">What is the Mentorship Program?</Text>
					<Text className="color gray">
						Our new mentorship program aims to increase design
						community bonds, elevate and support our emerging
						designers, and allow our members to form more
						personalized connections within the club. Mentees are
