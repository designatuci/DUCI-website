		...
		<Section className={cn.perks} id="activities-and-perks">
			...
			<div className={cn.list}>
				<div className={clsx(cn.item, "wait")}>
					...
					<Text color="gray">
						Connect with fellow designers and peers of all different experience
						levels
					</Text>
				</div>
				<div className={clsx(cn.item, "wait")}>
					<img alt="decorative" src={icon2} />
					<Text color="white">Hands-on Projects in Smaller Environments</Text>
					<Text color="gray">
				...
				<div className={clsx(cn.item, "wait")}>
					...
					<Text color="gray">
						Participate in more activities and boost up house points to win a
						prize!
					</Text>
				</div>
				<div className={clsx(cn.item, "wait")}>
					<img alt="decorative" src={icon4} />
					<Text color="white">Personalized 1:1 Communication with Board</Text>
					<Text color="gray">
