	...
	return (
		<>
			...
			<div id='nav' className='clear'>
				<div
					className='wrapper center flex row'
					style={{ height: '88px', display: 'flex' }}
				>
					...
					<div
						className='wideOnly center row group center'
					...
					>
						...
						>
							<Icon w='24' h='24' hoverable src='tiktok.svg' />
						</a>
						<a
							target='noreferer'
							...
							className='item social center'
						>
							<Icon w='24' h='24' hoverable src='instagram.svg' />
						</a>
						<a
							target='noreferer'
							...
							className='item social center'
						>
							<Icon w='24' h='24' hoverable src='discord.svg' />
						</a>
						<a
							target='noreferer'
							...
							className='item social center'
						>
							<Icon w='24' h='24' hoverable src='facebook.svg' />
						</a>
						<a
							target='noreferer'
							...
							className='item social center'
						>
							<Icon w='24' h='24' hoverable src='linkedin.svg' />
						</a>
					</div>
				</div>
			</div>
			...
			<div class='maincontent'>
						...
						{[
							...
							},
							{
								...
								members: [
									{
										name: 'Ashley Chang',
										school: 'UC Davis - @ashhhcha',
									},
									{
										name: 'An Nguyen',
										school: 'UC Riverside - @annguyen.ig',
									},
									{
										name: 'Ryan Yang',
										school: 'UC Irvine - @veryfewsbux',
									},
									{
										name: 'Angel Yim',
										school: 'UC Berkeley - @angelysy_',
									},
								],
								project: 'Carbonology',
								description:
								...
								members: [
									{
										...
										school: 'University of North Texas - @nekobekoart',
									},
									{
										name: 'Brett Johnson',
										school: 'University of North Texas - @brett_c_johnson',
									},
									{
										name: 'Khrystal Mendonca',
										school: 'University of North Texas - @khrysleanna',
									},
									{
										name: 'Michael Romero',
										school: 'University of North Texas - @mjmrla',
									},
								],
								project: 'Readeasy',
								description:
									'An app that gives high school and middle school students the ability to access their schools’ banned books and the tools necessary to fight for their education.',
							},
						].map((item, i) => {
							return (
								<div
				...
				<Section className='flatBot'>
						...
						{[
							{
								...
								label: 'First place',
								prizes: [
									'$40 gift card for each person on the winning team',
									'Design at UCI and designathon stickers',
									'A feature on the Design at UCI website',
									'Free Sketch licenses',
									'1-on-1 mentorship session with a judge of your choice',
								],
							},
							{
								symbol: '2nd',
								label: 'Second place',
								prizes: [
									'$15 gift card for each person on the winning team',
									'Design at UCI and designathon stickers',
									'A feature on the Design at UCI website',
									'1-on-1 mentorship session with a judge of your choice',
								],
							...
							{
								symbol: 'Raffle',
								label: 'Randomly selected participants',
								prizes: [
									'All participants who submit a prototype are eligible to win',
									'Design at UCI sticker set',
									'Exclusive Designathon sticker',
									'1 year-subscription license for Axure RP Team Edition',
									'1 year-long Sketch license',
									'Sketch Swag',
								],
							},
						].map(item => {
					...
					<div className='split4 s-judges'>
						{[
							{
								name: 'Lillian Choi',
								photo: 'Lillian_Choi.png',
								role: 'UX Designer at Samsung Electronics America',
								pronouns: 'she/her',
							...
							{
								name: 'Nathan Gao',
								photo: 'Nathan_Gao.png',
								role: 'Experience Design Lead at Northwestern Mutual',
								pronouns: 'he/him',
								about: 'Nathan Gao is an Experience Design Lead at Northwestern Mutual, where he guides a small team of talented designers in tackling complex projects, helping everyday people navigate difficult life  and financial decisions. An avid technologist, music fan, and former operations guy, Nathan is a big believer in using design to shape better complex systems; helping those who have less, live better.',
							},
							{
								name: 'Jered Odegard',
								photo: 'Jered_Odegard.png',
								role: 'Coach at Zeal; Former Product Design Leader at Redfin, Expedia',
								pronouns: 'he/him',
								about: 'Jered is a career and leadership coach (CPCC, ACC) and former Head of Product Design. He has built world-class product for fortune 500 like 🏝 Expedia and raised design teams from startup to IPO at 🏡 Redfin. He is passionate about giving introverted designers a voice and creative ownership.',
							},
							{
								name: 'Vanessa Wong',
								photo: 'Vanessa_Wong.png',
								role: 'Senior Designer @ Accenture Interactive',
								pronouns: 'she/her',
					...
					<div className='split4'>
						{[
							...
							{
								name: 'Alan Chang',
								photo: 'Alan_Chang.png',
								role: 'VP of Outreach @ Commit the Change',
								pronouns: 'he/him',
								about: '',
							},
							{
								...
								role: 'UX Design Intern @ Amazon',
								pronouns: 'she/her',
								about: 'Fun Fact: She is the design at UCI 2022 president!',
							},
							{
								name: 'Evangeline Gao',
								photo: 'portrait/Evangeline_Gao.png',
								role: 'Vice President @ Design at UCI',
								pronouns: 'she/her',
								about: '',
							},
						].map(item => {
				...
				<Section id='s-rules' className='textAlignLeft'>
					...
					{[
						...
						return (
							<div className='flex row left top spaceChildrenSmall'>
								<Text
									size='L'
									style={{
										minWidth: '48px',
